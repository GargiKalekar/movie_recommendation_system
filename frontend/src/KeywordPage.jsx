    ...
    />
      ...
      <main className="sp-main">
        ...
        <h1 className="headline">
          <span className="headline-line fade-up delay-1">Hello, Cinephile</span>
        ...
        <div className={`sp-search-wrap fade-up delay-2 ${submitted ? "sp-search-wrap--submitted" : ""}`}>
          ...
          {/* Hint */}
          {!submitted && (
            <p className="sp-hint">Type part of a film's name</p>
          )}
        </div>
          <div className="sp-keyword-option">
  <span className="sp-keyword-text">
    Want to find movies similar to the one you watched?
  </span>
  <button
